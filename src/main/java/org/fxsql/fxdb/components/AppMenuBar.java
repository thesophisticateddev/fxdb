package org.fxsql.fxdb.components;
...
import org.fxsql.fxdb.controller.NewConnectionController;
import org.fxsql.fxdb.databaseManagement.DatabaseManager;
import org.fxsql.fxdb.utils.ApplicationTheme;
...
public class AppMenuBar extends MenuBar {
    ...
    private void openNewConnectionWindow() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("new-connection.fxml"));
